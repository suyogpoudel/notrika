        ...
        >
            <FieldGroup>
                ...
                <Field>
                    ...
                    >{form.formState.isSubmitting ? "Signing Up..." : "Sign Up"}</Button>
                </Field>

                <FieldSeparator className="*:data-[slot=field-separator-content]:bg-card">Or continue
                                                                                          with</FieldSeparator>
                ...
                <FieldDescription className="text-center">Already have an account? <Link
                    href="/sign-in"
                    className="underline underline-offset-4"
                >Sign In</Link></FieldDescription>
